...
public class ChessMatch {
	...
	private ChessPiece newPiece(String type, Color color) {
		...
		if (type.equals("H")) return new Knigth(board, color);
	...
	private void validateSourcePosition(Position position) {
		...
		if (!board.piece(position).isTherePossibleMove()) {
			throw new ChessException("A peca nao tem movementos possiveis!");
		}
	}
	
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("Essa peca nao pode executar esse movimento!");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("O rei da cor " + color + " nao existe no tabuleiro!");
	}
	...
	public String winner(Color color) {
		return (currentPlayer == Color.WHITE) ? "BRANCO" : "PRETO"; 
	}
